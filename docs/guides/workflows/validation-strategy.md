...
- 宿主浏览器 MCP / browser plugin 的真实页面验证
...
| 宿主浏览器 MCP / browser plugin 的真实页面验证 | smoke | 依赖真实浏览器与页面状态 |
...
- [browser-regression-matrix.md](../../reference/validation/browser-regression-matrix.md)
