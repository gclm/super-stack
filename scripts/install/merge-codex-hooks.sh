...
HOOK_SCRIPT="${RUNTIME_ROOT}/.codex/hooks/super_stack_state.py"
READONLY_HOOK_SCRIPT="${RUNTIME_ROOT}/scripts/hooks/readonly_command_guard.py"
TIMESTAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP_DIR="${SUPER_STACK_BACKUP_ROOT}/codex-hooks"
