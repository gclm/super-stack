...
copy_runtime_tree() {
  ...
  copy_path_into_dir "${REPO_ROOT}/scripts/check/check-browser-capability.sh" "$dest_root" "scripts/check/check-browser-capability.sh"
  copy_path_into_dir "${REPO_ROOT}/scripts/check/check-codex-runtime.sh" "$dest_root" "scripts/check/check-codex-runtime.sh"
  copy_path_into_dir "${REPO_ROOT}/scripts/check/validate-skills.py" "$dest_root" "scripts/check/validate-skills.py"
