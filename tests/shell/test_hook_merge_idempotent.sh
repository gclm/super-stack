...
mkdir -p "${HOME}/.codex/super-stack/.codex/hooks" "${HOME}/.codex/super-stack/scripts/hooks"
cp "${REPO_ROOT}/.codex/hooks/super_stack_state.py" "${HOME}/.codex/super-stack/.codex/hooks/super_stack_state.py"
cp "${REPO_ROOT}/scripts/hooks/readonly_command_guard.py" "${HOME}/.codex/super-stack/scripts/hooks/readonly_command_guard.py"
